...
| Linux/macOS hosted / Python 3.11, 3.12, 3.13 | [Six-job push and PR matrices](ci-acceptance.md), verified OS network denial | OFFLINE_TEST passed; exact patch versions in evidence |
